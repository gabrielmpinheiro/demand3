                            ...
                            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                                <div>
                                    ...
                                    <p className={`text-sm ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>
                                        {inv.dominio?.nome || inv.assinatura?.dominio?.nome || inv.suporte?.dominio?.nome || 'N/A'}
                                        {inv.referencia_mes ? ` • ${inv.referencia_mes}` : ''}
                                        {inv.referencia ? ` • ${inv.referencia}` : (inv.suporte ? ` • Chamado #${inv.suporte.id} - ${inv.suporte.mensagem?.substring(0, 30)}...` : '')}
                                    </p>
