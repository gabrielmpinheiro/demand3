...
export default function Register() {
    ...
    return (
        <div className="bg-white shadow-xl rounded-2xl p-8 border border-gray-100 max-w-md w-full">
            <div className="mb-6 text-center">
                ...
                <p className="text-gray-500 mt-1">Preencha os dados básicos para começar</p>
            </div>
            ...
            <form onSubmit={onSubmit} className="space-y-4">
                ...
                <div>
                    ...
                    <input ref={telefoneRef} type="tel" className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all" placeholder="(11) 99999-9999" required />
                </div>
                <div>
